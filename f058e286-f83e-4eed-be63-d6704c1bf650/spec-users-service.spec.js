...
describe("UsersServices", () => {
  ...
  it("should fetch user by id", () => {
    const mockUser = { id: 1, name: "Martina Romeo", email: "martina@example.com", gender: "female", status: "inactive" };
  ...
  it("should add a new user", () => {
    const newUser = { id: 3, name: "Luca Bianchi", email: "luca@example.com", gender: "male", status: "active" };
  ...
  it("should add a new post", () => {
    ...
    const mockPost = { id: 1, user_id: 1, title: "New Post", body: "Post body" };
  ...
  it("should return null if addUser fails", () => {
    service.addUser({}).subscribe((user) => {
